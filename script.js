...
const eventImageMap = {
    ...
    'brabas no comando': 'assets/brabas.mp4',
    ...
    'copa no tropi 2': 'assets/copanotropi.jpg',
    'copa no zé mex': 'assets/zemexicano.jpg',
    'ginga 2': 'assets/ginga2.jpg',
    ...
    'arena do goxtoso 2': 'assets/arenagoxtoso2.jpg',
    'arena neon 2': 'assets/arenaneon2.jpg',
    'kaza fanfest 2': 'assets/kazafanfest2.mp4',
    'arena garden 2': 'assets/arenagarden2.jpg, assets/arenagarden22.jpg',
    'after do arena garden': 'assets/afterarenagarden.jpg',
    'wav & friends - hexa edition 2': 'assets/wavhexa2.jpg',
    'copa na casinha 2': 'assets/copanacasinha2.jpg',
    'afftezão': 'assets/afftezao.jpg',
    'bananada': 'assets/bananada.jpg',
    ...
    'after da papoco na rua': 'assets/afterpapoconarua2.jpg'
}
...
function getSortedEvents(events) {
    ...
    eventsToSort.sort((a, b) => {
        ...
        const dateAStr = getProp(a, 'Data') || getProp(a, 'Date') || '';
...
function createEventCardElement(event) {
    ...
    // Destaque para Bateu com Fritas em 08/08
    const eventDate = getProp(event, 'Data') || getProp(event, 'Date') || '';
    if (eventName.toLowerCase().includes('bateu com fritas') && eventDate.startsWith('08/08')) {
        card.classList.add('event-card--featured');
    }
